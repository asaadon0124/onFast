...
<body>
        ...
        <div class="login-html">
            ...
            <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab text-center">استعادة كلمة المرور</label>
            <div class="login-form">

               <form action="{{ route('forgetPassword.post.User') }}" method="post" style="margin-top: 30px">
                @csrf
                    <div class="sign-in-htm">
                        ...
                        <div class="hr"></div>
                        <div class="foot-lnk">
                            <a href="{{ route('welcome') }}">   تسجيل الدخول</a>
                        </div>
                    </div>
               </form>
