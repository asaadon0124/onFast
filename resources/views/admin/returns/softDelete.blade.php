                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($orders as $order)
                                                <tr class="orderRow{{ $order->id }}">
                                                    ...
                                                    <td>{{ $order->product->rescive_date}}</td>
                                                    <td>{{ $order->order->servant->name}}</td>
                                                    <td>{{ $order->product->supplier->name}}</td>
                                                    <td>{{ $order->product->resever_name}}</td>
                                                    <td>{{ $order->product->resver_phone}}</td>
                                                    <td>{{ $order->product->cities->governorate->name}}</td>
                                                    <td>{{ $order->product->cities->name}}</td>
                                                    <td>{{ $order->product->adress}}</td>
