                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="rescive_date" class="form-control" placeholder="ادخل تاريخ التسليم" value="{{ $product->rescive_date }}">
                               ...
                               {{-- CITY ID  --}}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="product_price" class="form-control" placeholder="ادخل سعر الشحنة" value="{{ $product->product_price }}" id="productPrice">
    ...
    @section('js')
        ...
        <script>
            ...
            $(document).ready(function()
            {
                ...
                {
                    var total_price = parseInt($('#totalPrice').val());
                    var shipping_price = parseInt($("#shippingPrice").val());
                    var product_price = parseInt($("#productPrice").val());
