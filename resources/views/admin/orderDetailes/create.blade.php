				...
				success: function(data)
				{
                    ...
                    $.each(data,function(key,value)
                    {
                        $('#productRow').append("<tr class="+'productRow'+value.id+">"+
                            ...
                            "<td>"+
                                "<button class='btn btn-success createProductToOrder' id='add' product_id="+value.id+">اضافة</button>"+
                                 "<button class='btn btn-danger deleteProductToOrder' id='delete' product_id="+value.id+" style='display:none'>حزف</button>"
                            +"</td>"+
