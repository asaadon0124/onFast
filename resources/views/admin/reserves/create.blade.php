				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<select  class="form-control" id="gov" name="supplier_id">
				...
				<div class="card-body">
					...
					<div class="table-responsive">
                            ...
                            <form action="{{ route('reserves.store') }}" method="post">
                                ...
                                <input type="submit" value="حفظ" class="form-control" style="background-color: #0ff ;">
                            </form>
				...
				success: function(data)
				{
                    ...
                    $.each(data,function(key,value)
                    {
                        $('#productRow').append("<tr class="+'productRow'+value.id+">"+
                            ...
                            "<td>"+
                                "<button class='btn btn-success createProductToOrder' id='add' product_id="+value.id+">تحصيل</button>"                            +"</td>"+
...
<!-- GET SUPPLIER ID TO SAVE ORDERS IN RESEVE FILE  -->
    <script>
        $(document).on('click','#makeCreateOrder',function(e)
            {
                var supplier    = $('#gov').val();
                var submitForm  = $('#sup_id').val(supplier);
                // alert(submitForm);
            });
    </script>
@endsection
