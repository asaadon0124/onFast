						...
						<ul class="slide-menu">
							...
							<li>
								...
								<span class="badge badge-danger side-badge">
									{{ $sidebarCounts['servants_deleted'] }}
								</span>
							</li>
						</ul>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li>
								...
								<span class="badge badge-danger side-badge">
									{{ $sidebarCounts['products_completed'] }}
								</span>
							</li>
							...
							<li>
								...
								<span class="badge badge-danger side-badge">
									{{ $sidebarCounts['products_deleted'] }}
								</span>
							</li>
						</ul>
					</li>
